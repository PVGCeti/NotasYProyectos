...
>Es posible que te aparezca un warning a la hora de importar un modulo de esta manera, para saber como solucionarlo vaya al apartado de [[Warning al importar modulos en NodeJS]]
...
>Es posible que te aparezca el buffer en vez del contenido a la hora de utilizar la función, para saber como solucionarlo vaya al apartado  de [[Contenido ilegible con readFile en Node JS]]
...
>Es posible que te aparezca un error de que el directorio o fichero no existe, para saber como solucionarlo vaya al apartado [[Directorio no existe al crearlo con mkdir en Node JS]]
